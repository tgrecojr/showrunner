...
describe('App routing', () => {
  ...
  it('renders Search at /search', async () => {
    ...
    await waitFor(() => expect(screen.getByText('SearchPage')).toBeInTheDocument());
  });
  ...
  it('renders Calendar at /calendar', async () => {
    ...
    await waitFor(() => expect(screen.getByText('CalendarPage')).toBeInTheDocument());
  });

  it('renders Settings at /settings', async () => {
    await renderAt('/settings');
    await waitFor(() => expect(screen.getByText('SettingsPage')).toBeInTheDocument());
  });
});
